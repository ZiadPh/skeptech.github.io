        ...
        <div  className="projects-title"><span className='projects-number'>#00</span> Projects</div>
        {
          projects.map((project, index) =>(
            <div className="project" key={index}>
              <ul>
                <li > <span className="project-name"> <span className='project-number'>#0{index+1}</span>{project.name} </span><img src={project.url}></img><div className="projects-description"data-scroll data-scroll-sticky data-scroll-target="#projects-container"><div className="project-title">{project.dTitle}</div><div className="project-desc">{project.description}</div></div><div className="dash"></div></li>
              </ul>
